...
# ASN.1 source file://.\Sentry4-MIB.mib
# Produced by pysmi-0.1.3 at Thu Nov 29 11:33:35 2018
...
if mibBuilder.loadTexts: sentry4.setRevisions(('2017-08-25 15:30', '2017-06-15 18:30', '2016-11-18 23:40', '2016-09-21 23:00', '2016-04-25 21:40', '2015-02-19 10:00', '2014-12-23 11:30',))
if mibBuilder.loadTexts: sentry4.setLastUpdated('201708251530Z')
...
st4UnitType = MibTableColumn((1, 3, 6, 1, 4, 1, 1718, 4, 1, 2, 2, 1, 7), Integer32().subtype(subtypeSpec=SingleValueConstraint(0, 1, 2, 3)).clone(namedValues=NamedValues(("master", 0), ("link", 1), ("controller", 2), ("emcu", 3)))).setMaxAccess("readonly")
...
st4OutletSocketAdapter = MibTableColumn((1, 3, 6, 1, 4, 1, 1718, 4, 1, 8, 2, 1, 9), Integer32().subtype(subtypeSpec=SingleValueConstraint(0, 1, 2)).clone(namedValues=NamedValues(("none", 0), ("c13", 1), ("c19", 2)))).setMaxAccess("readwrite")
